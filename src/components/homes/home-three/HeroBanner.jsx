...
import DropdownWithTabs from "../../search-dropdown/home-dropdown/DropdownWithTabs";
         ...
         <div className="container position-relative z-2">
            <div className="row">
               <div className="col-lg-10 m-auto">
                  <h1 className="hero-heading text-center text-white font-garamond fw-500 wow fadeInUp"><span><img src={titleShape} alt="" className="lazy-img" /> Find the Right</span> <br /> Home for Your Family</h1>
				...
				<div className="row">
					<div className="col-xxl-10 m-auto">
                        ...
                        <DropdownWithTabs style={true} />
                     </div>
                  </div>
               </div>
            </div>
         </div>
         <img src={bannerShape_1} alt="" className="lazy-img shapes shape_01" />
         <img src={bannerShape_2} alt="" className="lazy-img shapes shape_02" />
      </div>
   )
}
