  ...
  return (
    <>
      ...
      <div className="sidebar-sticky-bar">
        <div className="sidebar-sticky-bar-inner">
          <div className="quick-contact">
            <a href="tel:+66123456789" className="contact-item">
              <i className="fas fa-phone-alt"></i>
            </a>
            <a href="mailto:info@d-luckproperty.com" className="contact-item">
              <i className="fas fa-envelope"></i>
            </a>
            <a href="https://line.me/ti/p/~dluckproperty" className="contact-item">
